...
class RatPasta(_Pasta):
    ...
    parameters are passed to the :py:meth:`~.load_startle_data()` method, which stores the working data
    ...
    All parameters are passed to the :py:meth:`~.load_startle_data()` method's R function - only
    ...
    :ivar df: R dataframe of raw .pasta data imported using load_startle_data(), passed
             by default to the summary and plotting methods.
    :vartype df: rpy2.robjects.vectors.DataFrame
    :ivar summary: A dictionary containing three pandas dataframes: "values", "ratio" and "ratio_s",
                  automatically (re)generated on every data load.
    :vartype summary: dict of pandas.core.frame.DataFrame
    :ivar plots: A dictionary containing plots generated by the last invocation of each of the
    ...
    :ivar last_plot: Contains the last generated plot by any of the plotting methods.
    ...
    def summarise_startle(self, df=None, *args, **kwargs):
        ...
        :param df: R dataframe to be processed, defaults to :py:attr:`self.df`
                   (auto-generated using :py:meth:`~.load_startle_data()` when instantiating the RatPasta class)
        :param \*args: Arguments, passed verbatim to the respective R function.
        :param \**kwargs: Keyword arguments, passed verbatim to the respective R function.

        :return: A dictionary containing three pandas dataframes: `values`, `ratio` and `ratio_s`,
                 which is also stored in :py:attr:`self.summary`.
    ...
    def basic_startle_plot(self, df=None, *args, **kwargs):
        ...
        :param df: R dataframe to be plotted, defaults to :py:attr:`self.df`
                   (auto-generated using :py:meth:`~.load_startle_data()`
                   when instantiating the :py:class:`RatPasta` class)
        :param \*args: Arguments, passed verbatim to the respective R function.
        :param \**kwargs: Keyword arguments, passed verbatim to the respective R function.
    ...
    def startle_plot(self, df=None, type=None, *args, **kwargs):
        ...
        :return: A ggplot, which is also stored in :py:attr:`self.plots` and :py:attr:`self.last_plot`.
        :rtype: `rpy2.robjects.lib.ggplot2.GGPlot`"""
        if not df:
            df = self.df
        if not type:
    ...
    def plot_show(self, plot_key=None):
        ...
        Displays the last plot generated (stored in :py:attr:`self.last_plot`) in
    ...
    def plot_save(self, plot=None, plot_key=None, *args, **kwargs):
        ...
        the `ggsave` wrapper function, :py:func:`~.r_ggsave`.
        For more information, please refer to ggplot2's ggsave documentation.

        :param plot: Plot to save, defaults to the last generated plot (:py:attr:`self.last_plot`).
        :type plot: str
